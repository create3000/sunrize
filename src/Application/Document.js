...
module .exports = class Document extends Interface
{
   ...
   constructor ()
   {
      ...
      this .topBar             = new TopBar ($("#browser-top-bar"), this);
   ...
   async initialize ()
   {
      ...
      this .browser .getRenderingProperties () ._SoundDestinations .addInterest ("toggleMuteButton", this);
   ...
   activate (active)
   {
      ...
      else
      {
         ...
         this .#wasLive ??= this .browser .isLive ();
   ...
   async restoreFile ()
   {
      if (this .fileId)
      {
         ...
         {
            await this .loadURL (encodeURI (/* xml */ `data:model/x3d+xml,
<X3D profile='Interchange'>
   ...
   toggleMuteButton ()
   {
      electron .ipcRenderer .sendToHost ("mute-button", this .browser .getRenderingProperty ("SoundDestinations"));
   }
