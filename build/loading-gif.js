...
function main ()
{
   ...
   systemSync (`magick -delay 40 src/assets/images/loading3.gif src/assets/images/loading2.gif src/assets/images/loading1.gif -loop 0 src/assets/images/loading.gif`)
